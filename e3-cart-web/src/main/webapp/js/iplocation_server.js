...
function getBuyUrl(skuId){
    ...
    if (pageConfig.product.cat[2] == 4833) return "http://chongzhi.jd.com/cart/order_place.action?skuId=" + skuId + "";
    if (pageConfig.product.cat[2] == 4835 || pageConfig.product.cat[2] == 4836) return "http://card.jd.com/cart/order_place.action?skuId=" + skuId + "";
