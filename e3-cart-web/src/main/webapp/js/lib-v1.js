...
// "http://127.0.0.1:8081/rest/itemcat/all?callback=category.getDataService",
		URL_Serv: "http://localhost:8082/js/category.js",
      ...
      // $.getJSONP(this.URL_BrandsServ, category.getBrandService)
        ...
        var a = document.getElementById("settleup") ? $("#settleup dl") : $("#settleup-2013 dl"), b = a.find("dd").eq(0), c = function(a) {
            ...
            if (d > 0 ? (b.html(MCART.TPL_List.wrap.process(a.Cart)), b.find("#settleup-content .smc").html(e + f + g + i + h), $("#settleup-url").attr("href", "http://cart.jd.comhttp://localhost:8090/cart/showCart?r=" + +new Date)) : b.html(MCART.TPL_NoGoods), $.browser.msie && 6 == $.browser.version) {
...
// "http://cart.jd.comhttp://localhost:8090/cart/showCart?r=" + +new Date)
// }
//        
