...
(function() {
    ...
    RegExp("-" + e + "-").test(t) && $("#choose-amount").hide(), (4835 == e || 4836 == e) && (setAmount.urlPerfix = "http://card.jd.com/cart/order_place.action?", setAmount.data = null, setAmount.data = {skuId: G.sku}), 4833 == e && (setAmount.urlPerfix = "http://chongzhi.jd.com/cart/order_place.action?", setAmount.data = null, setAmount.data = {skuId: G.sku})
