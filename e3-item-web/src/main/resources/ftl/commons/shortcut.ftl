	...
	<div class="w">
		...
		<ul class="fr lh">
			...
			<li class="fore3 ld menu" id="app-jd" data-widget="dropdown" clstag="homepage|keycount|home2013|01d">
				...
				<a href="http://app.jd.com/" target="_blank">手机宜立方</a><b></b>
			</li>
			...
			<li class="fore5 ld menu" id="site-nav" data-widget="dropdown" clstag="homepage|keycount|home2013|01f">
				...
				<div class="dd lh">
					<dl class="item fore1">
						<dt>特色栏目</dt>
						<dd>
							<div><a target="_blank" href="http://mobile.jd.com/index.do">宜立方通信</a></div>
							...
							<div><a target="_blank" href="http://club.jd.com/">宜立方社区</a></div>
