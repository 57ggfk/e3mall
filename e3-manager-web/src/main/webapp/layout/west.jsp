...
<div class="easyui-accordion" data-options="fit:true,border:false">
	<div title="商品管理" data-options="border:false">
		<ul id="menu" class="easyui-tree"
			...
			<li data-options="attributes:{'url':'system/item-add'}">新增商品</li>
			<li data-options="attributes:{'url':'system/item-list'}">查询商品</li>
			<!-- 	         		<li data-options="attributes:{'url':'system/item-param-list'}">规格参数</li> -->
	...
	<div title="广告管理" data-options="border:false">
		<ul id="menu1" class="easyui-tree"
			...
			<li data-options="attributes:{'url':'system/content-category'}">内容分类管理</li>
			<li data-options="attributes:{'url':'system/content'}">内容管理</li>
			<li data-options="attributes:{'url':'system/import-index'}">索引库维护</li>
