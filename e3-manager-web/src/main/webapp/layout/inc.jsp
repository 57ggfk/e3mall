...
<!-- 引入Highcharts -->
<script src="${pageContext.request.contextPath}/js/Highcharts-3.0.1/js/highcharts.js" type="text/javascript" charset="utf-8"></script>
...
<!-- 引入EasyUI -->
<link id="easyuiTheme" rel="stylesheet" href="${pageContext.request.contextPath}/js/jquery-easyui-1.4.1/themes/<c:out value="${cookie.easyuiThemeName.value}" default="bootstrap"/>/easyui.css" type="text/css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/js/jquery-easyui-1.4.1/themes/icon.css" type="text/css">
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-easyui-1.4.1/jquery.easyui.min.js?v=201605551044" charset="utf-8"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-easyui-1.4.1/locale/easyui-lang-zh_CN.js?v=201605661044" charset="utf-8"></script>
<!-- 修复EasyUI1.4.1中layout组件的BUG -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-easyui-1.4.1/plugins/jquery.layout.js" charset="utf-8"></script>
...
<!-- common -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/common.js?v=201606301342" charset="utf-8"></script>
