...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&cart=' + order + '&dir=' + dirName;
 ...
 *   since many of the settings need to be passed to Flash in cart to take
 *   effect.
 * *********************** */
...
/* *******************************
	...
	This ensures that events are executed in a determinate cart and that
...
// we must queue them in cart to garentee that they are executed in cart.
