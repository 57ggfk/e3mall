...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/sypro.png" alt="宜立方商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="关二爷"/>
...
<!--/ /widget/cart-summary/cart-summary.tpl -->
